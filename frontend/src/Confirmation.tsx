            ...
            <Row className="mb-3">
                <Col>
                    <ul>
                        ...
                        <li className="mb-3">Put Monday, August 26th on your calendar for our Welcome/Informational Meeting! Please bring the required (and recommended) hard copy forms to complete your registration process.</li>
