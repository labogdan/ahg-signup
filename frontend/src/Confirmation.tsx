            ...
            <Row className="mb-3">
                <Col>
                    <ul>
                        ...
                        <li className="mb-3">Put Monday, August 26th on your calendar for our Welcome Meeting! Please bring the required (and recommended) hard copy forms to complete your registration process.</li>
                        <li className="mb-3"><strong>Please fill them out on your browser, print, and bring them with you to the Welcome Meeting on Monday, August 26th.</strong></li>
                        <li className="mb-3" style={{marginLeft: '40px'}}><a href="https://media.trooptrack.com/troop_documents/69749/document/original/VA9020_Troop_Meeting_Permission_Slip_2023.pdf" target="_blank">Troop Meeting Permission Slip</a> (one per family)</li>
